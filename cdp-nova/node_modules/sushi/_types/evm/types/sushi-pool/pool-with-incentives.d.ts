...
export declare enum RewarderType {
    Primary = "Primary",
    Secondary = "Secondary"
}
...
export type PoolWithIncentives<T extends PoolId = PoolId> = T & PoolIfIncentivized<T> & PoolWithIncentiveApr<T> & {
    incentives: Incentive[];
};
//# sourceMappingURL=pool-with-incentives.d.ts.map