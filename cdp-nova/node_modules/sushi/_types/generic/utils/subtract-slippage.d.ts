 ...
 */
export declare function subtractSlippage<TCurrency extends Currency>(amount: Amount<TCurrency>, slippage: number): Amount<TCurrency>;
//# sourceMappingURL=subtract-slippage.d.ts.map