...
export type Chain<TType extends ChainType = ChainType, TChainId extends ChainId = ChainId, TKey extends ChainKey = ChainKey, TName extends string = string, TShortName extends string = string, TNetType extends Readonly<NetType> = Readonly<NetType>, TBlockExplorerKeys extends BlockExplorers = BlockExplorers, TAddress extends string = string, TTransactionHash extends string = string> = Readonly<{
    type: TType;
    chainId: TChainId;
    key: TKey;
    name: TName;
