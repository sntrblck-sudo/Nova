export declare const chains: readonly [{
    ...
    readonly key: "polygon-zkevm";
    readonly name: "Polygon zkEVM";
    readonly shortName: "pol-zkevm";
    readonly netType: "mainnet";
    readonly blockExplorers: import("./interface.js").BlockExplorers | {
        [key: string]: {
            name: string;
    ...
    readonly key: "filecoin";
    readonly name: "Filecoin Mainnet";
    readonly shortName: "fil";
    readonly netType: "mainnet";
    readonly blockExplorers: import("./interface.js").BlockExplorers | {
        [key: string]: {
            name: string;
    ...
    readonly key: "zksync-era";
    readonly name: "ZKsync Era";
    readonly shortName: "zksync-era";
    readonly netType: "mainnet";
    readonly blockExplorers: import("./interface.js").BlockExplorers | {
        [key: string]: {
            name: string;
    ...
    readonly key: "zetachain";
    readonly name: "ZetaChain";
    readonly shortName: "zetachain";
    readonly netType: "mainnet";
    readonly blockExplorers: import("./interface.js").BlockExplorers | {
        [key: string]: {
            name: string;
    ...
    readonly viemChain: Omit<{
        ...
        readonly contracts: {
            readonly multicall3: {
                readonly address: "0x825267e0fa5cae92f98540828a54198dcb3eaeb5";
                readonly blockCreated: 146055;
            };
        };
    };
    readonly getTransactionUrl: (input: import("../../evm/index.js").EvmAddress) => string;
    ...
    readonly key: "berachain";
    readonly name: "Berachain";
    readonly shortName: "bera";
    readonly netType: "mainnet";
    readonly blockExplorers: import("./interface.js").BlockExplorers | {
        [key: string]: {
            name: string;
    ...
    readonly parentChainId: 11155111;
    readonly viemChain: Omit<{
        blockExplorers: {
            readonly default: {
                readonly name: "Arbiscan";
    ...
    readonly chainId: -1;
    readonly key: "aptos";
    readonly shortName: "apt";
    readonly name: "Aptos";
    readonly blockExplorers: {
        readonly default: {
            readonly name: "Aptos Explorer";
            readonly url: "https://explorer.aptoslabs.com";
        };
    };
    readonly netType: "mainnet";
} & {
    ...
    readonly chainId: -2;
    readonly name: "Tron";
    readonly shortName: "trx";
    readonly key: "tron";
    readonly blockExplorers: {
        readonly default: {
            readonly name: "Tronscan";
            readonly url: "https://tronscan.io";
        };
    };
    readonly netType: "mainnet";
} & {
...
export declare const chainIds: (1 | 10 | 25 | 30 | 56 | 56288 | 137 | 250 | 100 | 42161 | 42170 | 43114 | 1666600000 | 42220 | 2222 | 1088 | 288 | 199 | 1101 | 108 | 314 | 11235 | 1116 | 324 | 59144 | 8453 | 534352 | 7000 | 81457 | 2046399126 | 5000 | 169 | 34443 | 167000 | 810180 | 33139 | 146 | 43111 | 747474 | 999 | 80094 | 9745 | 11155111 | 421614 | 129399 | -1 | -2 | -3)[];
...
export type MainnetChainId = Extract<(typeof chains)[number], {
    netType: 'mainnet';
}>['chainId'];
export declare function isMainnetChainId(chainId: number): chainId is MainnetChainId;
export type TestnetChainId = Extract<(typeof chains)[number], {
    netType: 'testnet';
}>['chainId'];
export declare function isTestnetChainId(chainId: number): chainId is TestnetChainId;
export type ChainKey = (typeof chains)[number]['key'];
export declare function isChainKey(key: string): key is ChainKey;
export declare function getChainByKey<C extends ChainKey>(key: C): Extract<(typeof chains)[number], {
    key: C;
}>;
