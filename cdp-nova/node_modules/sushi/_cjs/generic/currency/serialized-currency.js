...
const token_js_1 = require("../../kvm/currency/token.js");
const token_js_2 = require("../../mvm/currency/token.js");
const index_js_1 = require("../../tvm/index.js");
const serializedCurrencySchema = (opts = {}) => z.union([
    (0, currency_js_1.serializedEvmCurrencySchema)(opts),
    (0, token_js_2.serializedMvmTokenSchema)(opts),
    (0, index_js_1.serializedTvmCurrencySchema)(opts),
    (0, token_js_1.serializedKvmTokenSchema)(opts),
]);
