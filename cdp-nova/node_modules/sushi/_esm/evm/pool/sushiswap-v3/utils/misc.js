 ...
 */
export function getCapitalEfficiency(priceCurrent, priceLower, priceUpper) {
 ...
 */
export function getTokenRatio(priceCurrent, priceLower, priceUpper) {
    if (priceCurrent.gt(priceUpper) || priceCurrent.eq(priceUpper))
        return [0, 1];
    if (priceCurrent.lt(priceLower) || priceCurrent.eq(priceLower))
        return [1, 0];
 ...
 */
export const getPriceRangeWithTokenRatio = (priceCurrent, priceLower, priceUpper, independentBound, weight0) => {
    if (weight0 === 1) {
        return [
