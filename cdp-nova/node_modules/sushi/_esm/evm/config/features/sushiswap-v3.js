 ...
 */
export var SushiSwapV3FeeAmount;
...
})(SushiSwapV3FeeAmount || (SushiSwapV3FeeAmount = {}));
/**
...
export const SUSHISWAP_V3_INIT_CODE_HASH = {
    ...
    [EvmChainId.BLAST]: '0x8e13daee7f5a62e37e71bf852bcd44e7d16b90617ed2b17c24c2ee62411c5bae',
...
export const isSushiSwapV3ChainId = (chainId) => SUSHISWAP_V3_SUPPORTED_CHAIN_IDS.includes(chainId);
...
export const isDeprecatedSushiSwapV3ChainId = (chainId) => DEPRECATED_SUSHISWAP_V3_CHAIN_IDS.includes(chainId);
