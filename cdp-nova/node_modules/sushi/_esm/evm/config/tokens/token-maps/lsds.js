...
import { METH, rETH, STONE, WstETH, } from '../../../config/tokens/tokens/index.js';
...
export function isLsd(currency) {
    if (currency.type === 'native') {
        return false;
    }
    return LSDS[currency.chainId]?.some((lsd) => lsd.address.toLowerCase() === currency.address.toLowerCase());
}
