...
import { APE_USD, axlUSDC, BASE_USDbC, BTTC_USDC_BSC, BTTC_USDC_ETHEREUM, BTTC_USDC_TRON, BTTC_USDT_BSC, BTTC_USDT_ETHEREUM, BTTC_USDT_TRON, BUSD, DAI, DOC, FILECOIN_USDC_CELER, FILECOIN_USDT_CELER, FRAX, LUSD, MIM, OPTICS_USDC, STARGATE_USDC, STARGATE_USDT, THUNDERCORE_ANY_BUSD, THUNDERCORE_ANY_USDC, THUNDERCORE_ANY_USDT, USD_PLUS, USDB, USDC, USDe, USDP, USDPLUS, USDT, ZETA_USDC_BSC, ZETA_USDC_ETH, ZETA_USDT_BSC, ZETA_USDT_ETH, } from '../../../config/tokens/tokens/index.js';
...
export function isStable(currency) {
    if (currency.type === 'native') {
        return false;
    }
    return STABLES[currency.chainId]?.some((stable) => stable.address.toLowerCase() === currency.address.toLowerCase());
}
