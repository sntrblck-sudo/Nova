...
import { AGEUR, DAI, FRAX, LUSD, MAI, MIM, OP, SKL, SUSHI, UNI, USDB, USDC, USDT, WBTC, WETH9, } from '../../../config/tokens/tokens/index.js';
...
export const isShortCurrencyNameSupported = (chainId) => chainId in CHAIN_ID_SHORT_CURRENCY_NAME_TO_CURRENCY;
export const isShortCurrencyName = (chainId, shortCurrencyName) => {
    return (isShortCurrencyNameSupported(chainId) &&
        shortCurrencyName in CHAIN_ID_SHORT_CURRENCY_NAME_TO_CURRENCY[chainId]);
};
export const currencyFromShortCurrencyName = (chainId, shortCurrencyName) => {
