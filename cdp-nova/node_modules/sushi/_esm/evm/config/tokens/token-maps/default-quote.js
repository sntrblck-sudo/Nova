...
import { APE_USD, ARB, AUSD, axlUSDC, BUSD, GNO, OP, SUSHI, USDB, USDC, USDT, USDT0, WETH9, } from '../../../config/tokens/tokens/index.js';
import { EvmNative } from '../../../currency/native.js';
import { EvmToken } from '../../../currency/token.js';
import { WNATIVE } from '../wrapped-native.js';
export const defaultCurrency = {
    ...Object.fromEntries(evmChainIds.map((chainId) => [chainId, EvmNative.fromChainId(chainId)])),
