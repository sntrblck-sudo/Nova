...
export const isWNativeSupported = (chainId) => WNATIVE_ADDRESS[chainId] !== zeroAddress;
export function isWrapOrUnwrap({ from, to, }) {
    if (from.type === 'native' && from.wrap().isSame(to)) {
        return true;
    }
    return to.type === 'native' && to.wrap().isSame(from);
}
//# sourceMappingURL=wrapped-native.js.map