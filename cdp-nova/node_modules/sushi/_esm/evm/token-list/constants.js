...
export const UNSUPPORTED_TOKEN_LIST_URLS = [BA_LIST];
...
export const LINEA_LIST = 'https://raw.githubusercontent.com/Consensys/linea-token-list/main/json/linea-mainnet-token-shortlist.json';
...
export const DEFAULT_TOKEN_LIST_OF_TOKEN_LISTS_TO_DISPLAY = [
...
export const DEFAULT_ACTIVE_LIST_URLS = [OPTIMISM_LIST];
export const BLACKLIST_TOKEN_IDS = [
    // Fake Aptos token
