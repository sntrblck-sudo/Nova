import { getCreate2Address as _getCreate2Address, concat, getAddress, keccak256, pad, } from 'viem/utils';
...
export function getCreate2Address({ chainId, ...params }) {
    if ([EvmChainId.ZKSYNC_ERA, EvmChainId.ZKLINK].includes(chainId)) {
...
//# sourceMappingURL=get-create-2-address.js.map