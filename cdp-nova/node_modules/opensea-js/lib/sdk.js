...
class OpenSeaSDK {
    ...
    constructor(signerOrProvider, apiConfig = {}, logger) {
        ...
        const listingPaymentToken = (0, utils_1.getOfferPaymentToken)(this.chain).toLowerCase();
     ...
     */
    async createOffer({ asset, accountAddress, startAmount, quantity = 1, domain, salt, expirationTime, paymentTokenAddress, zone, }) {
     ...
     * @throws Error if paymentTokenAddress is not WETH on anything other than Ethereum mainnet.
     */
    async createListing({ asset, accountAddress, startAmount, endAmount, quantity = 1, domain, salt, listingTime, expirationTime, paymentTokenAddress, buyerAddress, englishAuction, includeOptionalCreatorFees = false, zone, }) {
     ...
     */
    async createCollectionOffer({ collectionSlug, accountAddress, amount, quantity, domain, salt, expirationTime, paymentTokenAddress, offerProtectionEnabled = true, traitType, traitValue, }) {
