...
const getFulfillListingPayload = (fulfillerAddress, order_hash, protocolAddress, chain, assetContractAddress, tokenId) => {
    const payload = {
        listing: {
            hash: order_hash,
            chain,
...
const getFulfillOfferPayload = (fulfillerAddress, order_hash, protocolAddress, chain, assetContractAddress, tokenId) => {
    const payload = {
        offer: {
            hash: order_hash,
            chain,
