...
export declare const getFulfillListingPayload: (fulfillerAddress: string, order_hash: string, protocolAddress: string, chain: Chain, assetContractAddress?: string, tokenId?: string) => {
    listing: {
        hash: string;
        chain: Chain;
        protocol_address: string;
...
export declare const getFulfillOfferPayload: (fulfillerAddress: string, order_hash: string, protocolAddress: string, chain: Chain, assetContractAddress?: string, tokenId?: string) => {
    offer: {
        hash: string;
        chain: Chain;
        protocol_address: string;
