...
class OpenSeaAPI {
    ...
    constructor(config, logger) {
        ...
        this.ordersAPI = new orders_1.OrdersAPI(this.get.bind(this), this.post.bind(this), this.chain);
        this.offersAPI = new offers_1.OffersAPI(this.get.bind(this), this.post.bind(this));
        this.listingsAPI = new listings_1.ListingsAPI(this.get.bind(this));
        this.collectionsAPI = new collections_1.CollectionsAPI(this.get.bind(this));
        this.nftsAPI = new nfts_1.NFTsAPI(this.get.bind(this), this.post.bind(this), this.chain);
        this.accountsAPI = new accounts_1.AccountsAPI(this.get.bind(this), this.chain);
        this.eventsAPI = new events_1.EventsAPI(this.get.bind(this));
    }
    /**
    ...
    async generateFulfillmentData(fulfillerAddress, orderHash, protocolAddress, side, assetContractAddress, tokenId) {
        return this.ordersAPI.generateFulfillmentData(fulfillerAddress, orderHash, protocolAddress, side, assetContractAddress, tokenId);
    }
    /**
    ...
    async buildOffer(offererAddress, quantity, collectionSlug, offerProtectionEnabled = true, traitType, traitValue) {
        return this.offersAPI.buildOffer(offererAddress, quantity, collectionSlug, offerProtectionEnabled, traitType, traitValue);
    }
    /**
