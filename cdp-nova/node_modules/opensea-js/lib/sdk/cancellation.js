...
class CancellationManager {
    ...
    async cancelOrder({ order, orderHash, accountAddress, protocolAddress = utils_1.DEFAULT_SEAPORT_CONTRACT_ADDRESS, domain, }) {
        ...
        if (order) {
            ...
            orderToCancel = await this.context.api.getOrderByHash(orderHash, protocolAddress, this.context.chain);
            (0, utils_2.requireValidProtocol)(orderToCancel.protocolAddress);
        }
        else {
    ...
    async cancelOrders({ orders, orderHashes, accountAddress, protocolAddress = utils_1.DEFAULT_SEAPORT_CONTRACT_ADDRESS, domain, overrides, }) {
        ...
        if (orders) {
            ...
            for (const orderHash of orderHashes) {
                const order = await this.context.api.getOrderByHash(orderHash, protocolAddress, this.context.chain);
