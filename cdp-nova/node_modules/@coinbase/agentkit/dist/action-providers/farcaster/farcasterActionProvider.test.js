...
const farcasterActionProvider_1 = require("./farcasterActionProvider");
...
describe("Farcaster Action Provider Input Schemas", () => {
    describe("Account Details Schema", () => {
        it("should successfully parse empty input", () => {
            const validInput = {};
            const result = schemas_1.FarcasterAccountDetailsSchema.safeParse(validInput);
...
describe("Farcaster Action Provider", () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        actionProvider = new farcasterActionProvider_1.FarcasterActionProvider(mockConfig);
    });
    describe("accountDetails", () => {
        ...
        it("should successfully retrieve Farcaster account details", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(`https://api.neynar.com/v2/farcaster/user/bulk?fids=${mockConfig.agentFid}`, {
                method: "GET",
                headers: {
    ...
    describe("constructor", () => {
        it("should use environment variables when config is not provided", () => {
            ...
            const provider = new farcasterActionProvider_1.FarcasterActionProvider();
        ...
        it("should throw error when required config is missing", () => {
            ...
            expect(() => new farcasterActionProvider_1.FarcasterActionProvider()).toThrow();
            process.env = originalEnv;
        });
    });
