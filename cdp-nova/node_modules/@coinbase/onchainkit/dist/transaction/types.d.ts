...
import { Address, ContractFunctionParameters, Hex, TransactionReceipt, WalletCapabilities as ViemWalletCapabilities } from 'viem';
import { Config } from 'wagmi';
import { SendTransactionMutateAsync } from 'wagmi/query';
import { TransactionError } from '../api/types';
import { ToastProps } from '../internal/components/Toast';
export type Call = {
    to: Hex;
    data?: Hex;
    value?: bigint;
 ...
 * Note: exported as public Type
 */
export type TransactionToastProps = Pick<ToastProps, 'duration' | 'position' | 'className'> & {
