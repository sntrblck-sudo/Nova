import { default as sdk } from '@farcaster/miniapp-sdk';
...
type SwapTokenReturnOriginal = ReturnType<typeof useMutation<Awaited<ReturnType<typeof sdk.actions.swapToken>>, Error, SwapTokenParams>>;
type SwapTokenReturn = Omit<SwapTokenReturnOriginal, 'mutate' | 'mutateAsync'> & {
 ...
 */
export declare function useSwapToken(): SwapTokenReturn;
export {};
//# sourceMappingURL=useSwapToken.d.ts.map