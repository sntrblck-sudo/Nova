...
type SendTokenReturnOriginal = ReturnType<typeof useMutation<Awaited<ReturnType<typeof sdk.actions.sendToken>>, Error, SendTokenParams>>;
type SendTokenReturn = Omit<SendTokenReturnOriginal, 'mutate' | 'mutateAsync'> & {
 ...
 */
export declare function useSendToken(): SendTokenReturn;
export {};
