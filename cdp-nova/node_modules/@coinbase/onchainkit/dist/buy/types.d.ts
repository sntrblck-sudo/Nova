import { APIError, GetSwapQuoteResponse } from '../api/types';
import { LifecycleStatusUpdate } from '../internal/types';
import { LifecycleStatus, SwapConfig, SwapError, SwapUnit } from '../swap/types';
...
export type BuyContextType = {
    ...
    updateLifecycleStatus: (state: LifecycleStatusUpdate<LifecycleStatus>) => void;
