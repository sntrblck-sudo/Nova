...
export declare function useSwapBalances({ address, fromToken, toToken, }: {
    ...
    fromTokenResponse: {
        ...
        isRefetching: boolean;
        isStale: boolean;
        refetch: (options?: import('@tanstack/react-query').RefetchOptions) => Promise<import('@tanstack/react-query').QueryObserverResult<unknown, import('viem').ReadContractErrorType>>;
        fetchStatus: import('@tanstack/react-query').FetchStatus;
