import { RequestContextType } from './constants';
 ...
 */
export declare function sendRequest<T, V>(method: string, params: T[], _context?: RequestContextType): Promise<JSONRPCResult<V>>;
