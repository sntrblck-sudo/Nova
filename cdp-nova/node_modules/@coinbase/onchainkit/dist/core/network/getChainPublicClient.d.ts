...
export declare function getChainPublicClient(chain: Chain): {
    ...
    createAccessList: (parameters: import('viem').CreateAccessListParameters<Chain | undefined>) => Promise<{
    ...
    estimateFeesPerGas: <chainOverride extends Chain | undefined = undefined, type extends import('viem').FeeValuesType = "eip1559">(args?: import('viem').EstimateFeesPerGasParameters<Chain | undefined, chainOverride, type> | undefined) => Promise<import('viem').EstimateFeesPerGasReturnType<type>>;
    ...
    watchBlocks: <includeTransactions extends boolean = false, blockTag extends import('viem').BlockTag = "latest">(args: import('viem').WatchBlocksParameters<import('viem').Transport, Chain | undefined, includeTransactions, blockTag>) => import('viem').WatchBlocksReturnType;
