import { Attestation, EASSchemaUid } from '../../identity/types';
...
export declare const attestationQuery: string;
/**
 ...
 */
export declare function getAttestationQueryVariables(address: Address, filters: GetAttestationQueryVariablesFilters): AttestationsQueryVariables;
/**
 ...
 */
export declare function getAttestationsByFilter<TChain extends Chain>(address: Address, chain: TChain, filters: GetAttestationsByFilterOptions): Promise<GetAttestationsByFilterResponse>;
export {};
