...
type ContractCallArg = string | Address | Quantity | boolean | Array<ContractCallArg> | ActionOutputReference<Quantity>;
/**
 ...
 */
type BridgeProtocol = "ccip" | "relay" | "stargate";
/**
...
declare class EnsoClient {
     ...
     * );
     */
    getBundleData(params: BundleParams & {
        skipQuote?: boolean;
    }, actions: BundleAction[]): Promise<BundleData>;
    /**
...
export { type ActionData, type Address, type ApproveData, type ApproveParams, type BalanceParams, type BridgeProtocol, type BridgeStatusData, type BridgeStatusParams, type BundleAction, type BundleData, type BundleParams, type CcipRouterData, type CcipRouterParams, type ConnectedNetwork, EnsoClient, type IporShortcutData, type IporShortcutInputData, type LayerZeroPoolData, type LayerZeroPoolParams, type MultiPriceParams, type Network, type NonTokenizedPositionData, type PriceData, type PriceParams, type Project, type ProtocolData, type ProtocolParams, type RouteData, type RouteParams, type RoutingStrategy, type StandardAction, type StandardData, type TokenData, type TokenParams, type WalletBalance };
