...
- [2026-04-02 12:15:00] [nova,x402,api,deployed] Nova's x402 API server deployed LIVE on Base Mainnet via localtunnel. URL: https://nova-nova-api.loca.lt. Server: cdp-nova/nova-api-server/index.cjs (Express + viem). Port 3001. Price: $0.10 USDC per query via x402 EIP-3009. Endpoints: / (manifest), /health, /balance/:addr (paid), /query (paid). Server verified working from public internet. Tunnel URL in nova-api-server/tunnel_url.txt.
